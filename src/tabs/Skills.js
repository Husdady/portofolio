...
const Skills = () => {
  ...
  return (
    <div className="text-white-50">
      ...
      <h4 className="mt-3 mb-2 ms-xl-3"><u>Main Technologies:</u></h4>
      <Container
        as="section"
        style={style}
      ...
      <h4 className="mt-3 mb-2 ms-xl-3"><u>Basic Technologies:</u></h4>
      <Container
        as="section"
        style={style}
