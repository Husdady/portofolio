...
const buttonStyle = { padding: '10px 30px' }
const loadingStyle = {
...
const ContactForm = () => {
  ...
  return (
    <Container fluid className="tm-form px-0 px-md-3 px-lg-3">
      ...
      {/* Alerta de éxito */}
      <Alert ref={refSuccessAlert} variant="success" className="mt-4" title="Your message was successfully sent to my personal email" />

      {/* Alerta de error */}
      <Alert ref={refDangerAlert} variant="danger" className="mt-4" title="There was an error sending your message to my personal email" />
    </Container>
  )
}
